...
public class Validator {
     ...
     * 正则表达式：验证E币数�?
     */
    public static final String REGEX_EICON = "^[0-9]$";
    
    /**
     * 
     * 正则表达式：验证昵称
     */
    public static final String REGEX_NICKNAME = "^[a-zA-Z0-9_]{6,16}$";
    
    /**
     * 正则表达式：验证手机�?
     */
    public static final String REGEX_MOBILE = "^((1[2-9][0-9]))\\d{8}$";

...
import com.gangxiang.aiDaiOrder.zoomabledrawee.gestures.TransformGestureDetector;
...
public class DefaultZoomableController
  ...
  public void postScale() {
    mActiveTransform.postScale(1.0f, 1.0f, 20.0f, 20.0f);
  }
  ...
  public void onGestureUpdate(TransformGestureDetector detector) {
    ...
    if (mIsScaleEnabled) {
      ...
      FLog.v("DefaultZoomableController", "getScale : view %f %f %f", scale,detector.getPivotX(),detector.getPivotY());
    ...
    FLog.v("DefaultZoomableController", "onGestureUpdate : view %b", mIsTranslationEnabled);
    limitTranslation();
    if (mListener != null) {
      mListener.onTransformChanged(mActiveTransform);
    }
